...
if nargin==1
    ...
    metricsInfo.widths.long = [6 5 5   6 9 16 9 14 17 11 15 15 11 14 5 5 8];
    metricsInfo.widths.short = [6 5 5  5 5 5 4 4 4 4 6 6 5 5 5 5 5];

    metricsInfo.format.long = {'.2f','.2f','.2f', ...
        '.1f','.1f','.2f', ...
        'i','i','i','i', ...
        'i','i','i','i', ...
        '.1f','.1f','.1f'};
