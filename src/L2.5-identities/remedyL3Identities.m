function [updatedIdentities] = remedyL3Identities(opts,trajs,labels)
...
[spacetimeAffinity, impossibilityMatrix, indifferenceMatrix] = getSpaceTimeAffinityL3(trajs,trajs);
correlationMatrix = ...
