function outputTrajectories = createTrajectories(opts, inputTrajectories, startTime, endTime, iCam,appear_model_param,motion_model_param)
...
result = solveInGroups(opts, tracklets(inAssociation), trackletLabels(inAssociation), iCam,appear_model_param,motion_model_param);
