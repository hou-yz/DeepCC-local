...
opts.sequence = 1;
opts.sequence_names = {'trainval', 'test_mini', 'test_easy', 'test_hard', 'test_labeled','test_all','train','val'};
opts.seqs = {[1,3,4],6,2,5,[2,6],[2,5],[3,4],1};
opts.folder_by_scene = {'train', 'test','train', 'train','test','test'};
opts.cams_in_scene = {1:5,6:9,10:15,16:40,[10,16:29,33:36],[27,28,33:35]};
